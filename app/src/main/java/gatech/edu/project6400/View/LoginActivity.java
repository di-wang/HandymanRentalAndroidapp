...
public class LoginActivity extends AppCompatActivity {
    ...
    private void checkRadioButtons() {
        RadioButton customer_button = (RadioButton) findViewById(R.id.customer_radiobutton);
        if (customer_button.isChecked()) {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            UserDBService loginDBService = new UserDBService();

            if (isCustomer) {
                loginDBService.loginCustomer(email, password, this);
            } else {
                loginDBService.loginClerk(password, this);
            }
        }
    }

    public void continueCustomerLogin() {
        String email = mEmailView.getText().toString();
        Intent intent = new Intent(this, ViewProfile.class);
        intent.putExtra("CustomerID", email);
        startActivity(intent);
    }

    public void continueClerkLogin() {
        String password = mPasswordView.getText().toString();
        Intent intent = new Intent(this, PickUpReservation.class);
        intent.putExtra("ClerkID", password);
        startActivity(intent);
    }
